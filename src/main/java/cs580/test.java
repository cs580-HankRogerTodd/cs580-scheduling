...
public class test
{
	...
	private void DBtest()
	{
		...
		long EmployeeSize = mongoCollection.count();
		long MeetingSize = mongoCollectionMeeting.count();
		long RoomSize = mongoCollectionRooms.count();
		long AdminSize = mongoCollectionAdmin.count();
		...
		{
			String StringRoom = String.valueOf(1000+i);
			
			Bson filter = new Document("RoomNo", 1003);
